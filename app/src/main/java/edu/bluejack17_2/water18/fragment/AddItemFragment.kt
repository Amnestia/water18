...
class AddItemFragment : Fragment(), View.OnClickListener
{
    ...
    fun addItem()
    {
        val name=tf_name.toString()
        val price=tf_price.toString() as Long
        val stock=tf_quantity.toString() as Long
        FirebaseProductController.insertProduct(Product("",name,price,stock, Timestamp()))
